...
class MapController extends AbstractController
{
    ...
    {
        if ($lastTreasureTile = $tileRepository->findOneBy(['hasTreasure' => true])) {
            $lastTreasureTile->setHasTreasure(false);
        }

        $treasureTile = $mapManager->getRandomIsland();

        $treasureTile->setHasTreasure(true);
